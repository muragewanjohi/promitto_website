        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center py-4 sm:py-6 space-y-4 lg:space-y-0">
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1 text-xs sm:text-sm">Manage and organize your property listings</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center bg-[#1E40AF] hover:bg-[#1E3A8A] text-white px-3 sm:px-4 py-2 rounded-lg font-medium transition-colors duration-200 shadow-sm text-xs sm:text-sm"
              >
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                  <svg className="w-3 h-3 sm:w-5 sm:h-5 text-[#1E40AF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="ml-2 sm:ml-4">
                ...
                <p className="text-lg sm:text-xl font-semibold text-gray-900">{properties.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-2 sm:ml-4">
                ...
                <p className="text-lg sm:text-xl font-semibold text-gray-900">{properties.filter(p => p.status_name === 'completed').length}</p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <div className="w-6 h-6 sm:w-8 sm:h-8 bg-orange-100 rounded-lg flex items-center justify-center">
                  <svg className="w-3 h-3 sm:w-5 sm:h-5 text-[#F59E0B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-3 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-2 sm:ml-4">
                ...
                <p className="text-lg sm:text-xl font-semibold text-gray-900">{filteredAndSortedProperties.length}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-4 sm:mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              <h3 className="text-sm sm:text-base font-medium text-gray-900">Filters & Sorting</h3>
              <div className="flex items-center space-x-2">
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value as any)}
                  className="text-xs sm:text-sm border border-gray-300 rounded-md px-2 sm:px-3 py-1.5 sm:py-1 focus:outline-none focus:ring-2 focus:ring-[#1E40AF] w-full sm:w-auto"
                >
                ...
                <button
                  ...
                  className="p-1.5 sm:p-1 text-gray-400 hover:text-gray-600 transition-colors duration-200"
                >
                  {sortOrder === 'asc' ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-md px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#1E40AF] focus:border-transparent"
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="block lg:hidden">
                  {filteredAndSortedProperties.map((property) => (
                    <div key={property.id} className="border-b border-gray-200 p-4 hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              ...
                              <p className="text-xs text-gray-500 mt-1">{property.type_name}</p>
                              <p className="text-xs text-gray-600 mt-1">{property.location}</p>
                              <p className="text-sm font-semibold text-gray-900 mt-1">{formatPrice(property.price)}</p>
                            </div>
                          ...
                          <div className="flex items-center space-x-2 mt-3">
                            <Link
                              ...
                              className="inline-flex items-center px-2 py-1 text-xs font-medium text-[#1E40AF] bg-blue-50 hover:bg-blue-100 rounded-md transition-colors duration-200"
                            >
                              Edit
                            </Link>
                            <button
                  ...
                  <div key={property.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow duration-200">
                    ...
                    <div className="p-4 sm:p-6">
                      <div className="flex justify-between items-start mb-2 sm:mb-3">
                        <h3 className="text-sm sm:text-lg font-medium text-gray-900 truncate flex-1 mr-2">{property.name}</h3>
                      ...
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2">{property.type_name}</p>
                      <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">{property.location}</p>
                      <p className="text-sm sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">{formatPrice(property.price)}</p>
                      
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                        <button
                          onClick={() => handleToggleFeatured(property.id, property.featured)}
                          className={`px-2 sm:px-3 py-1 rounded-full text-xs font-semibold transition-colors duration-200 w-full sm:w-auto ${
                            property.featured
                              ? 'bg-[#1E40AF] text-white hover:bg-[#1E3A8A]'
                              : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                          }`}
                        ...
                        <div className="flex items-center space-x-2">
                          <Link
                            href={`/admin/properties/${property.id}`}
                            className="text-[#1E40AF] hover:text-[#1E3A8A] text-xs sm:text-sm font-medium transition-colors duration-200 flex-1 text-center"
                          >
                            Edit
                          </Link>
                          <button
                            className="text-red-600 hover:text-red-900 text-xs sm:text-sm font-medium transition-colors duration-200 flex-1 text-center"
                            onClick={() => handleDelete(property.id)}
                          >
                            Delete
                          </button>
