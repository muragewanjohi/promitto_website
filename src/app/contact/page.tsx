            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center justify-center space-x-3 disabled:opacity-50 disabled:transform-none"
                    disabled={loading}
                  >
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="mb-8">
                    ...
                    <Map 
                      location="Pension Towers, Loita St, Nairobi, Kenya" 
                      title="Kenya Office - Pension Towers Map" 
                    />
                  </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">Woodlands shopping mall, 1st floor</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">(+260) 775 604 455</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-4">
                        <div className="flex-shrink-0">
                  ...
                  <div>
                    <h4 className="text-lg font-medium text-gray-900 mb-3">Location</h4>
                    <Map 
                      location="Woodlands shopping mall, Lusaka, Zambia" 
                      title="Zambia Office - Woodlands Shopping Mall Map" 
                    />
                  </div>
                </div>
              </div>
