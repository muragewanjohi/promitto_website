  ...
  const fetchResources = async () => {
    try {
      ...
      const { data, error: fetchError } = await supabase
        ...
        .limit(50); // Limit to 50 resources to prevent timeout
            ...
            <div className="flex-1">
              ...
              <div className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h1 className="site-title text-gray-900">Resources</h1>
                </div>
                <p className="text-gray-600 text-lg">Browse our collection of helpful resources and guides</p>
              </div>
              ...
              {resourceItems.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 text-lg">No resources available at the moment.</p>
                </div>
              ) : (
