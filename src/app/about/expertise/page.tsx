        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">Project Planning</h4>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">Design & Architecture</h4>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg text-center hover:shadow-xl transition-shadow duration-300">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">Cost Management</h4>
              <p className="text-gray-600">
