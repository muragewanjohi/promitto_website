        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/properties" className="text-gray-300 hover:text-[#F59E0B] transition-colors">
                  Properties
                </Link>
              </li>
              <li>
          ...
          {/* Property Categories */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-[#F59E0B]">Property Types</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/properties?type=house" className="text-gray-300 hover:text-[#F59E0B] transition-colors">
                  Houses
                </Link>
              </li>
              <li>
                <Link href="/properties?type=apartment" className="text-gray-300 hover:text-[#F59E0B] transition-colors">
                  Apartments
                </Link>
              </li>
              <li>
                <Link href="/properties?type=villa" className="text-gray-300 hover:text-[#F59E0B] transition-colors">
                  Villas
                </Link>
              </li>
              <li>
                <Link href="/properties?type=commercial" className="text-gray-300 hover:text-[#F59E0B] transition-colors">
                  Commercial
                </Link>
              </li>
            </ul>
